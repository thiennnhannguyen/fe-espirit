      ...
      <div className="w-full max-w-2xl rounded-2xl bg-white shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="border-t border-gray-100 bg-gray-50 px-6 py-4 flex justify-end gap-3">
          ...
          <button 
            type="submit"
            form="event-form"
            className="rounded-lg bg-[#7A1E24] px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-[#5A212C] transition-colors focus:outline-none focus:ring-2 focus:ring-[#CAA46A] focus:ring-offset-1"
          >
            Lưu sự kiện
          </button>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 rounded-lg bg-[#7A1E24] px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-[#5A212C] focus:outline-none focus:ring-2 focus:ring-[#CAA46A] focus:ring-offset-1"
        >
          <Plus size={18} />
          Thêm bài viết mới
        </button>
